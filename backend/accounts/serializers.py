...
class FarmRegistrationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = ["username", "email", "password", "first_name", "last_name", "farm_name"]
...
class UserProfileSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = ["id", "username", "email", "first_name", "last_name", "role", "farm"]
     
    @extend_schema_field(FarmSerializer) # Fixed: Hinting the actual serializer instead of CharField
...
class PublicStockSerializer(serializers.ModelSerializer):
    class Meta:
        model = FlockBatch
        fields = ["id", "name", "batch_number", "current_stock", "age_in_weeks", "breed"]